...
async function createTablesDirectly() {
  ...
  if (error1) {
    console.error('Error creating mental wellness resources table:', error1);
  } else {
  ...
  if (error2) {
    console.error('Error creating emergency contacts table:', error2);
  } else {
  ...
  if (error3) {
    console.error('Error creating personalized recommendations table:', error3);
  } else {
  ...
  if (error4) {
    console.error('Error creating resource usage analytics table:', error4);
  } else {
    console.log('Resource usage analytics table created successfully');
  }
}
...
async function insertSampleData() {
  ...
  if (insertError) {
    console.error('Error inserting mental wellness resources:', insertError);
  } else {
